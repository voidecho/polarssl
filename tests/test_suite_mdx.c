...
#ifdef POLARSSL_RIPEMD160_C
void test_suite_ripemd160_hmac( int trunc_size, char *hex_key_string, char *hex_src_string,
                     char *hex_hash_string )
{
    unsigned char src_str[200];
    unsigned char key_str[200];
...
#ifdef POLARSSL_RIPEMD160_C
#ifdef POLARSSL_FS_IO
void test_suite_ripemd160_file( char *filename, char *hex_hash_string )
{
    unsigned char hash_str[41];
    unsigned char output[20];
...
int dispatch_test(int cnt, char *params[50])
{
    ...
    if( strcmp( params[0], "ripemd160_hmac" ) == 0 )
    {
    #ifdef POLARSSL_RIPEMD160_C
        ...
        test_suite_ripemd160_hmac( param1, param2, param3, param4 );
        return ( 0 );
    #endif /* POLARSSL_RIPEMD160_C */
    ...
    if( strcmp( params[0], "ripemd160_file" ) == 0 )
    {
    #ifdef POLARSSL_RIPEMD160_C
    #ifdef POLARSSL_FS_IO
        ...
        test_suite_ripemd160_file( param1, param2 );
        return ( 0 );
    #endif /* POLARSSL_RIPEMD160_C */
    #endif /* POLARSSL_FS_IO */

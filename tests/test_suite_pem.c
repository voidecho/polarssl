...
void test_suite_pem_write_buffer( char *start, char *end, char *buf_str, char *result_str )
{
...
int dispatch_test(int cnt, char *params[50])
{
    ...
    if( strcmp( params[0], "pem_write_buffer" ) == 0 )
    {
        ...
        test_suite_pem_write_buffer( param1, param2, param3, param4 );
        return ( 0 );

...
int verify_int( char *str, int *value )
{
    ...
    if( strcmp( str, "POLARSSL_DEBUG_LOG_RAW" ) == 0 )
    {
        *value = ( POLARSSL_DEBUG_LOG_RAW );
        return( 0 );
    }
    if( strcmp( str, "POLARSSL_DEBUG_LOG_FULL" ) == 0 )
    {
        *value = ( POLARSSL_DEBUG_LOG_FULL );
        return( 0 );
    }
...
void test_suite_debug_print_ret( int mode, char *file, int line, char *text, int value,
                      char *result_str )
{
    ssl_context ssl;
    struct buffer_data buffer;
...
void test_suite_debug_print_buf( int mode, char *file, int line, char *text,
...
void test_suite_debug_print_crt( int mode, char *crt_file, char *file, int line,
...
void test_suite_debug_print_mpi( int mode, int radix, char *value, char *file, int line,
                      char *prefix, char *result_str )
{
    ssl_context ssl;
    struct buffer_data buffer;
...
int dispatch_test(int cnt, char *params[50])
{
    ...
    if( strcmp( params[0], "debug_print_ret" ) == 0 )
    {
        ...
        test_suite_debug_print_ret( param1, param2, param3, param4, param5, param6 );
        return ( 0 );

        return ( 3 );
    }
    else
    if( strcmp( params[0], "debug_print_buf" ) == 0 )
    {
        ...
        test_suite_debug_print_buf( param1, param2, param3, param4, param5, param6 );
        return ( 0 );
    ...
    if( strcmp( params[0], "debug_print_crt" ) == 0 )
    {
        ...
        test_suite_debug_print_crt( param1, param2, param3, param4, param5, param6 );
        return ( 0 );
    #endif /* POLARSSL_FS_IO */
    #endif /* POLARSSL_X509_CRT_PARSE_C */
    ...
    if( strcmp( params[0], "debug_print_mpi" ) == 0 )
    {
        ...
        test_suite_debug_print_mpi( param1, param2, param3, param4, param5, param6, param7 );
        return ( 0 );
    #endif /* POLARSSL_BIGNUM_C */
